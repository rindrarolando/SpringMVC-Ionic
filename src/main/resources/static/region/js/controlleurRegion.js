...
function($scope,$http,$location,$window,$filter) {
  ...
  $scope.getSignalements=function($args,$id){
    ...
    $scope.getSignalementsEnCours=function($args,$id){
          ...
          $http.get('http://spring-ion.herokuapp.com/region/getSignalementEnCours?id='+$id+'', {
              headers : {'token':$args}
          }).then(function (response) {
        ...
        $scope.getSignalementsTermines=function($args,$id){
                  ...
                  $http.get('http://spring-ion.herokuapp.com/region/getSignalementsTermines?id='+$id+'', {
                      headers : {'token':$args}
                  }).then(function (response) {
  ...
  $http.get('http://spring-ion.herokuapp.com/signalement/attribuer?idSignalement='+$location.search().id+"&idRegion="+$scope.idregion).then(function (response) {
    ...
    $scope.test=function($args,$id){
        ...
        console.log($date);
        console.log($etat);
        $url = 'http://spring-ion.herokuapp.com/region/recherche?id='+$id+'&date='+$date+'&type='+$type+'&etat='+$etat+'';
        console.log($url);
        $http.get('http://spring-ion.herokuapp.com/region/rechercheSignalement?id='+$id+'&date='+$date+'&type='+$type+'&etat='+$etat+'', {
                              headers : {'token':$args}
                          }).then(function (response) {
                            $scope.signalementTermine=response.data;
        ...
        $scope.insertNotification = function($args){
            ...
            $http.get('http://spring-ion.herokuapp.com/region/getSignalement?id='+$location.search().id+'',{
                headers : {'token':$args}
            }).then(function (response) {
                $id = response.data.id;
                $dat = new Date();
  ...
  $scope.update=function($args,$id){
    ...
    $http.post('http://spring-ion.herokuapp.com/region/update?id='+$id,{
        headers : {'token':$args}
    }).then(function (response) {

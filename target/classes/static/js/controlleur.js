...
function($scope,$http) {
  $scope.getSignalements=function($args){
    $http.get('https://spring-ion.herokuapp.com/signalement/getNewSignalement',{
        headers : {'token':$args}
...
function($scope,$http,$location,$window) {
  $scope.getSignalement=function($args){
    ...
    $http.get('https://spring-ion.herokuapp.com/signalement/getSignalement?id='+$location.search().id+'', {
        headers : {'token':$args}
    }).then(function (response) {
    ...
    $http.get('https://spring-ion.herokuapp.com/region/getRegions',{
        headers : {'token':$args}
    }).then(function (response) {
...
function($scope,$http,$location) {
  ...
  $scope.getUtilisateurs=function($args){
      $http.get('https://spring-ion.herokuapp.com/utilisateur/getUtilisateurs',
      {
        headers : {'token':$args}
      }).then(function (response) {
    ...
    $scope.getTypeSignalements=function($args){
        $http.get('https://spring-ion.herokuapp.com/typesignalement/getTypeSignalements',{
            headers : {'token':$args}
        }).then(function (response) {
...
function($scope,$http,$location) {
  ...
  $scope.getModifierRegion=function(){
    $http.get('https://spring-ion.herokuapp.com/region/modifier?id='+$location.search().id).then(function (response) {
              $scope.region=response.data;
              console.log(response.data);
            });
  }
  $scope.getModifierUtilisateur=function(){
      $http.get('https://spring-ion.herokuapp.com/utilisateur/modifier?id='+$location.search().id).then(function (response) {
                $scope.region=response.data;
              });
    }
    $scope.getModifierType=function(){
        $http.get('https://spring-ion.herokuapp.com/typesignalement/modifier?id='+$location.search().id).then(function (response) {
                  $scope.region=response.data;
                });
      }
